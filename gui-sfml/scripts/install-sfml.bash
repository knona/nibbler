...
mkdir build
cd build
cmake -DCMAKE_INSTALL_PREFIX=$sfml -DCMAKE_C_COMPILER=/usr/bin/clang -DCMAKE_CXX_COMPILER=/usr/bin/clang++ -DCMAKE_POSITION_INDEPENDENT_CODE=y -DBUILD_SHARED_LIBS=n -DSFML_PKGCONFIG_INSTALL_PREFIX=n -DSFML_BUILD_AUDIO=n ..
make install 
